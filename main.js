      ...
      if (googleUser) {
        ...
        formArea.innerHTML = `
          <div class="pp-review-signin">
            ...
            <button class="pp-google-fallback-btn" id="pp-google-fallback-btn">
        ...
        // Try the official Google button first
        ...
        // If official button rendered, hide fallback; otherwise show it
        ...
        if (officialRendered && officialBtn && officialBtn.children.length > 0) {
